...
import { postTags, relatedContents } from "@/constants"
...
const Detail = () => {
  ...
  return (
    <div>
        {/* top info */}
        <aside className="flex w-full h-[70px] items-center low_opacity_bg gap-[10px] p-[15px]">
        ...
        <article className="w-[90%] mx-auto flex gap-[45px] mt-[30px]">
            ...
            <aside className="w-[60%]">
                ...
                <div className="mt-[30px]">
                   ...
                   <aside className="flex items-center gap-[30px] mt-[40px]">
                        <div className="flex flex-col gap-[5px]">   
                            <ThumbsUp className="cursor-pointer text-[18px] md:text-[22px] lg:text-[25px] focus:text-extra" />
                            <h4 className="font-medium"> 100 </h4>
                        </div>
                        <div className="flex flex-col gap-[5px]">   
                            <ThumbsDown className="cursor-pointer text-[18px] md:text-[22px] lg:text-[25px]" />
                            <h4 className="font-medium"> 100 </h4>
                        </div>
                        <div className="flex flex-col gap-[5px]">   
                            <MessageSquareText className="cursor-pointer text-[18px] md:text-[22px] lg:text-[25px]" />
                            <h4 className="font-medium"> 100 </h4>
                        </div>
                   </aside>
                </div>
            ...
            {/* right side */}
            <aside className="w-[30%] translate-y-[140px] sticky inset-0"> 
                {/* other categories */}
                <aside className="flex flex-col gap-[15px] min-h-[100px] w-[70%] mx-auto low_opacity_bg rounded-[8px] p-[20px]">
                    <h2 className="font-bold text-main text-[16px] md:text-[20px] lg:text-[25px]"> Tags </h2>
                    { postTags.map(tag => (
                        <aside key={tag.id} className="flex flex-col gap-[8px] cursor-pointer">
                            <h3 className="cursor-pointer text-[#fff] hover:text-extra3 font-bold"> {tag.tag} </h3>
                ...
                {/* related contents */}
                <aside className="flex flex-col gap-[15px] mt-[30px] min-h-[100px] w-[70%] mx-auto low_opacity_bg rounded-[8px] p-[20px]">
                    <h2 className="font-bold text-main text-[16px] md:text-[20px] lg:text-[25px]"> Related Contents </h2>
                    { relatedContents.map(content => (
                        <div key={content.id} className='flex w-full flex-col gap-[8px] cursor-pointer'>
                            <h3 className="cursor-pointer text-[#fff] hover:text-extra3 font-bold"> {content.title} </h3>
                            <p className="text-secondary text-[14px]"> {content.tag} </p>
                            <div className="h-[1px] bg-secondary w-full"/>
                        </div>
                    )) }
                </aside>
