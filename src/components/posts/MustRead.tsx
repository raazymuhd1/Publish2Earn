...
const MustRead = () => {
  return (
    <div className="min-h-[500px] mt-[25px]">
      ...
      {/* articles posts */}
      <article className="flex items-center gap-[20px] min-h-[300px] max-h-[350px]">
            <aside
                className="min-h-full global_shadow border-[3px] border-line flex flex-col gap-[10px]  p-[10px] w-[25%] cursor-pointer text-secondary bg-extra hover:scale-[1.2] transition-[transform_1s]">
                 ...
                 <div className="flex items-center gap-[10px]">
                    ...
                    <h4 className="font-semibold text-extra3"> Tommy Hawk </h4>
                    <div className="w-[4px] bg-secondary h-[4px] rounded-[50%]" />
                    <p> { new Date().toDateString() } </p>
                 </div>
                 <div className="flex flex-col gap-[10px] w-full">
                    <h1 className="font-extrabold lg:text-[25px] md:text-[20px] text-[18px] whitespace-normal w-[80%] text-main"> Unlocking the Power of AI in Blockchain </h1>
          ...
          <aside className="flex flex-col items-center gap-[10px] h-full w-[25%]">
             { dummyMustRead.map(must => (
                  <div
                    ...
                    <Image src={must.image} alt="image-post" className="w-full h-[30%] object-cover rounded-[15px]" />
                    <div className="flex items-center gap-[10px]">
                    ...
                    <div className="flex flex-col gap-[10px] w-full">
                        <h1 className="font-extrabold lg:text-[25px] md:text-[20px] text-[18px] whitespace-normal w-[80%] text-main"> { must.title } </h1>
                    </div>
                </div>
             )) }
          </aside>
