        ...
        <article className="flex flex-wrap items-center lg:justify-start justify-center gap-[20px] mt-[20px]">
            { dummyPosts.map(post => (
              ...
              <Link href="/post-details/1" key={post.id} 
                className="min-h-[200px] overflow-hidden max-h-[fit-content] global_shadow border-[3px] border-line flex flex-col gap-[10px] min-w-[250px] max-w-[350px] p-[10px] cursor-pointer text-secondary bg-extra hover:scale-[1] transition-[transform] duration-500 rounded-[15px]">
                 <Image src={post.image} alt="image-post" 
                    className="w-full h-[20%] object-cover hover:scale-[1] rounded-[15px]" />
