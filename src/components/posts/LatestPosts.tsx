  ...
  return (
    <div className="w-full mt-[25px]">
        ...
        <article className="flex flex-wrap items-center gap-[20px] mt-[20px]">
            { dummyPosts.map(post => (
              <div key={post.id} className="min-h-[300px] max-h-[fit-content] global_shadow border-[3px] border-line flex flex-col gap-[10px] min-w-[250px] max-w-[400px] p-[10px] cursor-pointer text-textMain">
